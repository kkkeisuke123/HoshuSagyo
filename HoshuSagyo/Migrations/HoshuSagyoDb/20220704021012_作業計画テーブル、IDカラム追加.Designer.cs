...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220704021012_作業計画テーブル、IDカラム追加")]
    partial class 作業計画テーブルIDカラム追加
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 4, 11, 10, 12, 32, DateTimeKind.Local).AddTicks(3576),
                            UpdateDateTime = new DateTime(2022, 7, 4, 11, 10, 12, 32, DateTimeKind.Local).AddTicks(3576)
                        },
                        new
                        {
                            Kankatsu = 2,
