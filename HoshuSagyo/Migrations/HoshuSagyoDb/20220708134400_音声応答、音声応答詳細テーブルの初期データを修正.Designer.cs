...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220708134400_音声応答、音声応答詳細テーブルの初期データを修正")]
    partial class 音声応答音声応答詳細テーブルの初期データを修正
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 8, 22, 44, 0, 376, DateTimeKind.Local).AddTicks(4373),
                            UpdateDateTime = new DateTime(2022, 7, 8, 22, 44, 0, 376, DateTimeKind.Local).AddTicks(4373)
                        },
                        new
                        {
                            Kankatsu = 2,
