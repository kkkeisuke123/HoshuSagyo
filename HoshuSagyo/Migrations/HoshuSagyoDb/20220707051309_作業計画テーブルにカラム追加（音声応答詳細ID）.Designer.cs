...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220707051309_作業計画テーブルにカラム追加（音声応答詳細ID）")]
    partial class 作業計画テーブルにカラム追加音声応答詳細ID
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 7, 14, 13, 9, 157, DateTimeKind.Local).AddTicks(9266),
                            UpdateDateTime = new DateTime(2022, 7, 7, 14, 13, 9, 157, DateTimeKind.Local).AddTicks(9266)
                        },
                        new
                        {
                            Kankatsu = 2,
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Transactions.SagyoKeikakuModel", b =>
                {
                    ...
                    b.Property<int>("OnseiOtoShosaiId")
                        .HasColumnType("int");
