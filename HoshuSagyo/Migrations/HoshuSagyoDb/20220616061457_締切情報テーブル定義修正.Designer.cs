...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220616061457_締切情報テーブル定義修正")]
    partial class 締切情報テーブル定義修正
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 6, 16, 15, 14, 56, 993, DateTimeKind.Local).AddTicks(2096),
                            UpdateDateTime = new DateTime(2022, 6, 16, 15, 14, 56, 993, DateTimeKind.Local).AddTicks(2096)
                        },
                        new
                        {
                            Kankatsu = 2,
