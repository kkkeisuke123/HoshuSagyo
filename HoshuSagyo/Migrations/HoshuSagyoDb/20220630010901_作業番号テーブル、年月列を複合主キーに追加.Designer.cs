...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220630010901_作業番号テーブル、年月列を複合主キーに追加")]
    partial class 作業番号テーブル年月列を複合主キーに追加
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 6, 30, 10, 9, 1, 767, DateTimeKind.Local).AddTicks(2222),
                            UpdateDateTime = new DateTime(2022, 6, 30, 10, 9, 1, 767, DateTimeKind.Local).AddTicks(2222)
                        },
                        new
                        {
                            Kankatsu = 2,
