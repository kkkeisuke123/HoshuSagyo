...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220707053659_作業計画テーブルにカラム追加（作業終了音声応答詳細ID、作業終了音声応答詳細ID）")]
    partial class 作業計画テーブルにカラム追加作業終了音声応答詳細ID作業終了音声応答詳細ID
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 7, 14, 36, 59, 497, DateTimeKind.Local).AddTicks(8869),
                            UpdateDateTime = new DateTime(2022, 7, 7, 14, 36, 59, 497, DateTimeKind.Local).AddTicks(8869)
                        },
                        new
                        {
                            Kankatsu = 2,
