...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220706130115_作業実績テーブル追加")]
    partial class 作業実績テーブル追加
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 6, 22, 1, 15, 595, DateTimeKind.Local).AddTicks(9676),
                            UpdateDateTime = new DateTime(2022, 7, 6, 22, 1, 15, 595, DateTimeKind.Local).AddTicks(9676)
                        },
                        new
                        {
                            Kankatsu = 2,
