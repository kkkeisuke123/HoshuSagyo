...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220706125744_進捗テーブル追加")]
    partial class 進捗テーブル追加
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 6, 21, 57, 44, 487, DateTimeKind.Local).AddTicks(5362),
                            UpdateDateTime = new DateTime(2022, 7, 6, 21, 57, 44, 487, DateTimeKind.Local).AddTicks(5362)
                        },
                        new
                        {
                            Kankatsu = 2,
