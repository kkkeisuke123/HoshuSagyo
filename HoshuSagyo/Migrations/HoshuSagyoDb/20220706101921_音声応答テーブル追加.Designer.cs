...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220706101921_音声応答テーブル追加")]
    partial class 音声応答テーブル追加
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 6, 19, 19, 21, 303, DateTimeKind.Local).AddTicks(1947),
                            UpdateDateTime = new DateTime(2022, 7, 6, 19, 19, 21, 303, DateTimeKind.Local).AddTicks(1947)
                        },
                        new
                        {
                            Kankatsu = 2,
