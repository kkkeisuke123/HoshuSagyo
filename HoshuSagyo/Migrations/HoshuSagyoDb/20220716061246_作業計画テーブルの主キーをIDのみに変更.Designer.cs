...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220716061246_作業計画テーブルの主キーをIDのみに変更")]
    partial class 作業計画テーブルの主キーをIDのみに変更
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 16, 15, 12, 45, 739, DateTimeKind.Local).AddTicks(7780),
                            UpdateDateTime = new DateTime(2022, 7, 16, 15, 12, 45, 739, DateTimeKind.Local).AddTicks(7780)
                        },
                        new
                        {
                            Kankatsu = 2,
