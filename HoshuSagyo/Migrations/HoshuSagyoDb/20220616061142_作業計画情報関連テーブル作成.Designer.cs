...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220616061142_作業計画情報関連テーブル作成")]
    partial class 作業計画情報関連テーブル作成
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 6, 16, 15, 11, 42, 621, DateTimeKind.Local).AddTicks(8403),
                            UpdateDateTime = new DateTime(2022, 6, 16, 15, 11, 42, 621, DateTimeKind.Local).AddTicks(8403)
                        },
                        new
                        {
                            Kankatsu = 2,
