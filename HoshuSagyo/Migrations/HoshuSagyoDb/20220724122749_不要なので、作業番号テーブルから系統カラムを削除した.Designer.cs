...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220724122749_不要なので、作業番号テーブルから系統カラムを削除した")]
    partial class 不要なので作業番号テーブルから系統カラムを削除した
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 24, 21, 27, 49, 295, DateTimeKind.Local).AddTicks(798),
                            UpdateDateTime = new DateTime(2022, 7, 24, 21, 27, 49, 295, DateTimeKind.Local).AddTicks(798)
                        },
                        new
                        {
                            Kankatsu = 2,
