...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220630005826_作業番号テーブル列名修正")]
    partial class 作業番号テーブル列名修正
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 6, 30, 9, 58, 26, 464, DateTimeKind.Local).AddTicks(55),
                            UpdateDateTime = new DateTime(2022, 6, 30, 9, 58, 26, 464, DateTimeKind.Local).AddTicks(55)
                        },
                        new
                        {
                            Kankatsu = 2,
