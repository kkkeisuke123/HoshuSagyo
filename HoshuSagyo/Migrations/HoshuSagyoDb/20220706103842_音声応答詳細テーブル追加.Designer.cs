...
namespace HoshuSagyo.Migrations.HoshuSagyoDb
{
    ...
    [Migration("20220706103842_音声応答詳細テーブル追加")]
    partial class 音声応答詳細テーブル追加
    {
            ...
            modelBuilder.Entity("HoshuSagyo.Models.Master.KankatsuModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Kankatsu = 1,
                            KankatsuName = "東京",
                            RegisterDateTime = new DateTime(2022, 7, 6, 19, 38, 42, 610, DateTimeKind.Local).AddTicks(424),
                            UpdateDateTime = new DateTime(2022, 7, 6, 19, 38, 42, 610, DateTimeKind.Local).AddTicks(424)
                        },
                        new
                        {
                            Kankatsu = 2,
